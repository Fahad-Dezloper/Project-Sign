...
const Navabar = () => {
    return (
        <div className='flex flex-col md:flex-row gap-3 items-center w-full justify-between'>
            ...
            <div className='navigation flex items-center justify-between overflow-hidden w-full bg-white rounded-full text-lg md:text-2xl'>
                <Link to="/interact" className='w-full md:px-6 md:py-2 px-6 py-1 cursor-pointer hover:bg-[#60A5FA] hover:!text-white text-white font-semibold duration-200 ease-in-out'>Interact</Link>
                <span>|</span>
